...
<Text style={styles.out}>${income}</Text>
<Text style={styles.in}>Self-Employment</Text>
<Text style={styles.out}>${sincomee</Text>
<Text style={styles.in}>Investment</Text>
<Text style={styles.out}>${investment}</Text>
<Text style={styles.in}>Pension</Text>
<Text style={styles.out}>${pension}</Text>
<Text style={styles.in}>Public Benefits</Text>
<Text style={styles.out}>${govIncome}</Text>
...
<Text style={styles.out}>${donation}</Text>
